...
def main(args, pressure_idx):
    ...
    path_dir_name = f'/mnt/j/isee_remote_data/{dataset_short_name}/wind_average/pressure_{pressure_idx}/{year}{str(month).zfill(2)}'
    ...
    wind_speed_average = np.sqrt(EW_wind_average**2E0 + NS_wind_average**2E0)
