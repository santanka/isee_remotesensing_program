...
dir_figure = f'/mnt/j/isee_remote_data/JST/front_trajectory_test'
...
fig_name = f'{dir_figure}/front_trajectory_{start_year}{start_month:02}{start_day:02}{start_hour:02}_{end_year}{end_month:02}{end_day:02}{end_hour:02}_{start_lat:.1f}_{start_lon:.1f}.png'
