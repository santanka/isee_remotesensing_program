...
l2prod = r'Rrs_678,rhos_531,rhos_645,rhos_748,rhos_859,latitude,longitude'
atmocor = 1
proc_ocean = 1
resolution = 1000
oformat = r'netCDF4'
...
if DataSource == 'AQUA':
    directory_GEO = f'{directory_base}/MODIS_data_L1A/AQUA_MODIS_GEO_hdf'
    directory_L1B_LAC = f'{directory_base}/MODIS_data_L1B/AQUA_MODIS_L1B'
    directory_L2 = f'{directory_base}/MODIS_data_L2/AQUA_MODIS_L2'
    startswith_l1b = 'AQUA_MODIS.'
elif DataSource == 'TERRA':
    directory_GEO = f'{directory_base}/MODIS_data_L1A/TERRA_MODIS_GEO_hdf'
    directory_L1B_LAC = f'{directory_base}/MODIS_data_L1B/TERRA_MODIS_L1B'
    directory_L2 = f'{directory_base}/MODIS_data_L2/TERRA_MODIS_L2'
...
def process_files(geo_file_path, l1b_file_path, l2_file_path):
    #command = f"l2gen ifile={l1b_file_path} geofile={geo_file_path} ofile1={l2_file_path} l2prod={l2prod} atmocor={atmocor} proc_ocean={proc_ocean} resolution={resolution} maskland={maskland} maskglint={maskglint} maskcloud={maskcloud} maskstlight={maskstlight} maskhilt={maskhilt} maskzen={maskzen} oformat={oformat}"
