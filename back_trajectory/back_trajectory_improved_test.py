...
while True:
    year_old = date_old.year
    month_old = date_old.month
    day_old = date_old.day
    hour_old = date_old.hour

    #Euler法
    lon_new_euler, lat_new_euler = euler_method(year_old, month_old, day_old, hour_old, longitude_euler[-1], latitude_euler[-1])
